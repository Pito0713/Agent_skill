...
> 三 harness 薄索引：CLAUDE.md（本檔）/ AGENTS.md（Codex）/ GEMINI.md（agy），共用本 repo 為唯一正本。
...
@rules/security.md
@skills/engineering/coding-workflow-core/SKILL.md
...
| 情境 | 讀這份 |
|------|--------|
| 查 skill coverage / package 路徑 | `skills/index.json` |
| 不知道用哪個 skill / 查觸發詞 | `skills/llms.txt` |
| 該載入哪些語言 / 框架 rules | `skills/engineering/coding-workflow-core/SKILL.md` Phase 0（常駐已含，照表偵測）|
