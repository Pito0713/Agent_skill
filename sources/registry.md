...
收集來源清單。每次新增 repo 時在此登記，再依照 `skills/convert-skill/SKILL.md` 流程處理。
...
- **收集狀態**：部分收集
- **對應分類**：productivity
- **已收錄 Skills**：`skills/productivity/smart-init/SKILL.md`
...
- **對應分類**：engineering
- **已收錄 Skills**：`skills/engineering/lazyengineer/SKILL.md`、`skills/engineering/lazyengineer-review/SKILL.md`
